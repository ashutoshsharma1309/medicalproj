-- ===========================================================================
-- AVERIS — complete schema (Phases 1-6)
--
-- Paste this whole file into the Supabase SQL Editor and run it once:
--   https://supabase.com/dashboard/project/<project-ref>/sql/new
--
-- Creates 19 tables, 58 RLS policies, private helper functions, the
-- private 'medical-documents' storage bucket, the pgvector retrieval function
-- and the job-claiming function.
--
-- Afterwards, paste these two generated seeds, in either order:
--   supabase/seed/model_metrics.sql   — ML comparison (ml/train_all.py)
--   supabase/seed/knowledge_base.sql  — knowledge corpus with embeddings
