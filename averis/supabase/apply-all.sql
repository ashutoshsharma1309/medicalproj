-- ===========================================================================
-- AVERIS — complete schema (Phases 1-4)
--
-- Paste this whole file into the Supabase SQL Editor and run it once:
--   https://supabase.com/dashboard/project/<project-ref>/sql/new
--
-- Creates 12 tables, 43 RLS policies, 7 private helper functions and the
-- private 'medical-documents' storage bucket.
--
-- Afterwards, paste supabase/seed/model_metrics.sql to populate the ML model
-- comparison table. That file is generated by ml/train_all.py.
--
